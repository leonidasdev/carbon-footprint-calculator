...
public class ElectricityFactorPanel extends JPanel {
    ...
    private void initialize() {
        ...
        JLabel mixUnit = new JLabel("kg CO2e/kWh"); mixUnit.setForeground(Color.GRAY);
        ...
        gdoTypeComboBox = new JComboBox<>(new String[]{"Mix sin GdO","Factor GdO renovable","Factor GdO cog. alta eficiencia"}); UIUtils.styleComboBox(gdoTypeComboBox);
